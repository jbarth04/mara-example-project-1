...
<create_file path="/home/ubuntu/repos/mara-example-project-1/microservices/common/database.py">
import os
import psycopg2
...
def execute_sql_file(connection, sql_file_path: str, params: Dict[str, Any] = None):
...
def execute_sql_statement(connection, sql_statement: str, params: Dict[str, Any] = None):
    with connection.cursor() as cursor:
        if params:
